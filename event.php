...
<html>
<head>
	<title>Takshashila|Events</title>
...
nav{
	background-color: #2ad1ca !important;
}
.tk{
	font-size: 20px;
}
...
<body>
	...
	<nav class="container-fluid" style="position:fixed;z-index:1;">
		<div class=" tk col-md-4">
			<a href="#" data-activates="slide-out" class="button-collapse" style="display:block;">&nbsp;
				<i class="fa fa-bars" aria-hidden="true" style="font-size:22px;">
			</i>
		</a>&nbsp;&nbsp;&nbsp;&nbsp;Takshashila
	...
	<ul id="slide-out" class="side-nav">
		...
		<a href="cause.php" ><li class="cont_10">Cause</li></a>
...
<div class=" first row"><a href="cultural.php">
				<div class="col-md-6">
					<center>
						<img src="img/nontechicon.png" class="img-responsive click" width="200" height="200" alt="logo">
					    <h1>CULTURALS</h1></center><h4></h4>
</div></a>
<div class="col-md-6"><a href="technical.php">
	<center>
		<img src="img/techicon.png" class="img-responsive click" width="200" height="200" alt="logo">
			<h1>TECHNICAL</h1></center><h4></h4>
</div></a>
</div>
<div class=" second row"><a href="sports.php">
				<div class="col-md-6">
					<center>
						<img src="img/sports.png" class="img-responsive click" width="200" height="200" alt="logo">
					    <h1>SPORTS</h1></center><h4></h4>
</div></a>
<div class="col-md-6"><a href="workshop.php">
	<center>
		<img src="img/workshopnew.png" class="img-responsive click" width="200" height="200"alt="logo">
			<h1>WORKSHOP</h1></center><h4></h4>
</div></a>
...
<div class="row">
	<div class="col-md-6">
		<center>
		<a href="funzone.php">
		<img src="img/funzone1.png" class="img-responsive click" width="200" height="200" alt="logo">
			<h1>FUN ZONE</h1>
		</a>
	</center>
	</div>
	...
	<center>
		<a href="cubing.php">
		<img src="img/cube.png" class="img-responsive click" width="200" height="200" alt="logo">
			<h1>CUBING</h1>
		</a>
	</center>
	</div>
